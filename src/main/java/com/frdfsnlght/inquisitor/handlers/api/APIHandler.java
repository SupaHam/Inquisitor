...
public abstract class APIHandler extends WebHandler {
	...
	protected void sendFailure(WebRequest req, WebResponse res, String error)
			throws IOException {
	...
	protected void sendSuccess(WebRequest req, WebResponse res, Object obj)
			throws IOException {
		TypeMap msg = new TypeMap();
	...
	protected void sendJSON(WebRequest req, WebResponse res, String json)
			throws IOException {
